...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (
        ...
        $errors[] = 'La data de finalització no pot ser anterior a la d’inici.';
    }
    ...
    <div class="col-md-7">
        ...
        <form method="post" class="card card-body shadow-sm">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="name" name="name" class="form-control" value="<?= h(
                    $values['name'],
                ) ?>" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea id="goal" name="goal" class="form-control" rows="4" required><?= h(
                    $values['goal'],
                ) ?></textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="date" id="start_date" name="start_date" class="form-control" value="<?= h(
                    $values['start_date'],
                ) ?>" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="date" id="end_date" name="end_date" class="form-control" value="<?= h(
                    $values['end_date'],
                ) ?>">
            </div>
            ...
            <div class="mb-3">
                ...
                <select id="status" name="status" class="form-select" required>
                    ...
                    <option value="active" <?= $values['status'] === 'active'
                        ? 'selected'
                        : '' ?>>Actiu</option>
                    <option value="inactive" <?= $values['status'] ===
                    'inactive'
                        ? 'selected'
                        : '' ?>>Inactiu</option>
                </select>
